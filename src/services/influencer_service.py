...
class InfluencerService:
    ...
    async def list_influencers(
        ...
        with sentry_sdk.start_span(op="influencer.list", name="List Influencers"):
    ...
    async def get_influencer(self, influencer_id: str) -> AIInfluencer:
        ...
        with sentry_sdk.start_span(op="influencer.get", name="Get Influencer Details") as span:
            span.set_data("influencer.id", influencer_id)
    ...
    async def list_nsfw_influencers(
        ...
        with sentry_sdk.start_span(op="influencer.nsfw_list", name="List NSFW Influencers"):
